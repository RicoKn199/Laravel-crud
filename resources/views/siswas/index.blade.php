                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('siswas.destroy',$siswa->id) }}" method="post">
                                    <a href="{{ route('siswas.edit', $siswa->id) }}" class="btn  btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
